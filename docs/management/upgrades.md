...
The variable file is located on the path: [roles/update/defaults/main.yml](https://github.com/autobase-tech/autobase/blob/2.7.2/automation/roles/update/defaults/main.yml)
...
The variable file is located on the path: [roles/upgrade/defaults/main.yml](https://github.com/autobase-tech/autobase/blob/2.7.2/automation/roles/upgrade/defaults/main.yml)
