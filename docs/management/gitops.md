...
image: autobase/automation:2.8.0
...
:::info
- **group_vars/all.yml**: Configuration variables — refer to the [default](https://github.com/autobase-tech/autobase/blob/2.8.0/automation/roles/common/defaults/main.yml) values. Override them as needed using group_vars, host_vars, or directly in the inventory file.
