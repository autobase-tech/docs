...
**[Autobase](https://github.com/autobase-tech/autobase)** is an internal PostgreSQL platform — giving you full control as a powerful alternative to cloud-managed databases — Database as a Service (DBaaS).
